...
class YoLov5TRT(object):
    ...
    def infer_subjects(self, image_raw):
        # threading.Thread.__init__(self)
        # Make self the active context, pushing it on top of the context stack.
        self.ctx.push()
        # Restore
        ...
        # Choose only a person class
        subjects = result_classid == 0  # The person class has classid of 0 (classid == 0)
        result_boxes = result_boxes[subjects]
